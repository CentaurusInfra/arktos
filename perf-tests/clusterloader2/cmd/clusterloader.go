...
import (
	...
	"k8s.io/kubernetes/perf-tests/clusterloader2/pkg/imagepreload"
	"k8s.io/kubernetes/perf-tests/clusterloader2/pkg/prometheus"
	"k8s.io/kubernetes/perf-tests/clusterloader2/pkg/test"
	"k8s.io/kubernetes/perf-tests/clusterloader2/pkg/util"

	_ "k8s.io/kubernetes/perf-tests/clusterloader2/pkg/measurement/common"
	_ "k8s.io/kubernetes/perf-tests/clusterloader2/pkg/measurement/common/bundle"
	_ "k8s.io/kubernetes/perf-tests/clusterloader2/pkg/measurement/common/probes"
	_ "k8s.io/kubernetes/perf-tests/clusterloader2/pkg/measurement/common/slos"
)
...
func initClusterFlags() {
	...
	flags.BoolEnvVar(&clusterLoaderConfig.ClusterConfig.DeleteStaleTenants, "delete-stale-tenants", "DELETE_STALE_TENANTS", false, "Whether to delete all stale tenants before the test execution.")
