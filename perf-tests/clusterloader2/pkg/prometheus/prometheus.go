...
func (pc *PrometheusController) SetUpPrometheusStack() error {
	...
	if err := client.CreateNamespace(k8sClient, metav1.TenantSystem, namespace); err != nil {
		return err
	}
...
func (pc *PrometheusController) TearDownPrometheusStack() error {
	...
	k8sClient := pc.framework.GetClientSets().GetClient()
	if err := client.DeleteNamespace(k8sClient, metav1.TenantSystem, namespace); err != nil {
		return err
	}
	if err := client.WaitForDeleteNamespace(k8sClient, metav1.TenantSystem, namespace); err != nil {
		return err
	}
	return nil
}
...
func dumpAdditionalLogsOnPrometheusSetupFailure(k8sClient kubernetes.Interface) {
	...
	list, err := client.ListEvents(k8sClient, metav1.TenantSystem, namespace, "prometheus-k8s")
	if err != nil {
