...
set-partitionserver
EXPECTED_NUM_NODES=$((EXPECTED_NUM_NODES+TOTALSERVER_EXTRA_NUM))
echo "TOTALSERVER_EXTRA_NUM: ${TOTALSERVER_EXTRA_NUM}, EXPECTED_NUM_NODES:${EXPECTED_NUM_NODES}, ALLOWED_NOTREADY_NODES:${ALLOWED_NOTREADY_NODES}"
