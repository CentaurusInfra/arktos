...
# This script is for configuring additional arktos workload controller instances. It is
...
function main() {
  ...
  echo "Start to configure workload controller instance for Arktos"
  ...
  echo "Done for the configuration for workload controller"
}
