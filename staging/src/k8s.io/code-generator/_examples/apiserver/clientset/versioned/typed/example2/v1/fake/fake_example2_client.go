...
func (c *FakeSecondExampleV1) TestTypesWithMultiTenancy(namespace string, tenant string) v1.TestTypeInterface {
...
func (c *FakeSecondExampleV1) RESTClients() []rest.Interface {
	var ret *rest.RESTClient
