...
func (c *FakeExample) TestTypesWithMultiTenancy(namespace string, tenant string) internalversion.TestTypeInterface {
...
func (c *FakeExample) RESTClients() []rest.Interface {
	var ret *rest.RESTClient
