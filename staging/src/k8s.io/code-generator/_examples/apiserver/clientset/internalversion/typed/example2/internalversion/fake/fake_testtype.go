...
func (c *FakeTestTypes) Get(name string, options v1.GetOptions) (result *example2.TestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(testtypesResource, c.ns, name, c.te), &example2.TestType{})
...
func (c *FakeTestTypes) Create(testType *example2.TestType) (result *example2.TestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(testtypesResource, c.ns, testType, c.te), &example2.TestType{})
...
func (c *FakeTestTypes) Update(testType *example2.TestType) (result *example2.TestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(testtypesResource, c.ns, testType, c.te), &example2.TestType{})
...
func (c *FakeTestTypes) UpdateStatus(testType *example2.TestType) (*example2.TestType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(testtypesResource, "status", c.ns, testType, c.te), &example2.TestType{})
...
func (c *FakeTestTypes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(testtypesResource, c.ns, name, c.te), &example2.TestType{})
...
func (c *FakeTestTypes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *example2.TestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(testtypesResource, c.te, c.ns, name, pt, data, subresources...), &example2.TestType{})
