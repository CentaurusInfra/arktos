...
type ObjectMeta struct {
	...
	// Cannot be updated.
	// +optional
	Tenant string `json:"tenant,omitempty" protobuf:"bytes,3,opt,name=tenant"`
	...
	// Read-only.
	// +optional
	SelfLink string `json:"selfLink,omitempty" protobuf:"bytes,5,opt,name=selfLink"`
	...
	// +optional
	Generation int64 `json:"generation,omitempty" protobuf:"varint,8,opt,name=generation"`
	...
	// +optional
	CreationTimestamp Time `json:"creationTimestamp,omitempty" protobuf:"bytes,9,opt,name=creationTimestamp"`
	...
	// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
	// +optional
	DeletionTimestamp *Time `json:"deletionTimestamp,omitempty" protobuf:"bytes,10,opt,name=deletionTimestamp"`
	...
	// Read-only.
	// +optional
	DeletionGracePeriodSeconds *int64 `json:"deletionGracePeriodSeconds,omitempty" protobuf:"varint,11,opt,name=deletionGracePeriodSeconds"`
	...
	// +optional
	Labels map[string]string `json:"labels,omitempty" protobuf:"bytes,12,rep,name=labels"`
	...
	// +optional
	Annotations map[string]string `json:"annotations,omitempty" protobuf:"bytes,13,rep,name=annotations"`
	...
	// +patchMergeKey=uid
	// +patchStrategy=merge
	OwnerReferences []OwnerReference `json:"ownerReferences,omitempty" patchStrategy:"merge" patchMergeKey:"uid" protobuf:"bytes,14,rep,name=ownerReferences"`
	...
	Initializers *Initializers `json:"initializers,omitempty" protobuf:"bytes,17,opt,name=initializers"`
	...
	// +optional
	// +patchStrategy=merge
	Finalizers []string `json:"finalizers,omitempty" patchStrategy:"merge" protobuf:"bytes,15,rep,name=finalizers"`
	...
	//
	// +optional
	ManagedFields []ManagedFieldsEntry `json:"managedFields,omitempty" protobuf:"bytes,18,rep,name=managedFields"`
}
