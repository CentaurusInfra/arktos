...
// Watch returns a watch.AggregatedWatchInterface that watches the requested foos.
func (c *FakeFoos) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
