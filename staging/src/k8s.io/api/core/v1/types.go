...
type PodSpec struct {
	...
	// +optional
	Overhead ResourceList `json:"overhead,omitempty" protobuf:"bytes,36,opt,name=overhead"`
	...
	TopologySpreadConstraints []TopologySpreadConstraint `json:"topologySpreadConstraints,omitempty" patchStrategy:"merge" patchMergeKey:"topologyKey" protobuf:"bytes,37,opt,name=topologySpreadConstraints"`
}
