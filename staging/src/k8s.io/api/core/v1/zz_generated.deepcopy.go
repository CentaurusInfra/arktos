...
func (in *ActionSpec) DeepCopyInto(out *ActionSpec) {
	*out = *in
	if in.PodAction != nil {
		in, out := &in.PodAction, &out.PodAction
		*out = new(PodAction)
		(*in).DeepCopyInto(*out)
	}
	if in.NodeAction != nil {
		in, out := &in.NodeAction, &out.NodeAction
		*out = new(NodeAction)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *ActionStatus) DeepCopyInto(out *ActionStatus) {
	*out = *in
	if in.PodActionStatus != nil {
		in, out := &in.PodActionStatus, &out.PodActionStatus
		*out = new(PodActionStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.NodeActionStatus != nil {
		in, out := &in.NodeActionStatus, &out.NodeActionStatus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodActionStatus) DeepCopyInto(out *PodActionStatus) {
	*out = *in
	if in.RebootStatus != nil {
		in, out := &in.RebootStatus, &out.RebootStatus
		*out = new(RebootStatus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodActionStatus.
func (in *PodActionStatus) DeepCopy() *PodActionStatus {
	if in == nil {
		return nil
	}
	out := new(PodActionStatus)
