...
func (c *FakePodMetricses) Get(name string, options v1.GetOptions) (result *v1alpha1.PodMetrics, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(podmetricsesResource, c.ns, name, tenant), &v1alpha1.PodMetrics{})
...
func (c *FakePodMetricses) List(opts v1.ListOptions) (result *v1alpha1.PodMetricsList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(podmetricsesResource, podmetricsesKind, c.ns, opts, c.te), &v1alpha1.PodMetricsList{})
