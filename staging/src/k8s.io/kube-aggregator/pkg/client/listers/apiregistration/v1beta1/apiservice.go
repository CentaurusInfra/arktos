...
func (s aPIServiceTenantLister) List(selector labels.Selector) (ret []*v1beta1.APIService, err error) {
...
func (s aPIServiceTenantLister) Get(name string) (*v1beta1.APIService, error) {
	key := s.tenant + "/" + name
	if s.tenant == "system" {
		key = name
	}
