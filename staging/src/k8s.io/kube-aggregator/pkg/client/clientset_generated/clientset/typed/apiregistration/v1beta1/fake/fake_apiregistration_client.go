...
func (c *FakeApiregistrationV1beta1) APIServicesWithMultiTenancy(tenant string) v1beta1.APIServiceInterface {
...
func (c *FakeApiregistrationV1beta1) RESTClients() []rest.Interface {
	var ret *rest.RESTClient
