...
func (c *FakeAPIServices) Get(name string, options v1.GetOptions) (result *v1beta1.APIService, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(apiservicesResource, name, tenant), &v1beta1.APIService{})
...
func (c *FakeAPIServices) List(opts v1.ListOptions) (result *v1beta1.APIServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantListAction(apiservicesResource, apiservicesKind, opts, c.te), &v1beta1.APIServiceList{})
...
// Watch returns a watch.AggregatedWatchInterface that watches the requested aPIServices.
...
func (c *FakeAPIServices) Create(aPIService *v1beta1.APIService) (result *v1beta1.APIService, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(apiservicesResource, aPIService, tenant), &v1beta1.APIService{})
...
func (c *FakeAPIServices) Update(aPIService *v1beta1.APIService) (result *v1beta1.APIService, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(apiservicesResource, aPIService, tenant), &v1beta1.APIService{})
...
func (c *FakeAPIServices) UpdateStatus(aPIService *v1beta1.APIService) (*v1beta1.APIService, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateSubresourceAction(apiservicesResource, "status", aPIService, tenant), &v1beta1.APIService{})
...
func (c *FakeAPIServices) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(apiservicesResource, name, tenant), &v1beta1.APIService{})
...
func (c *FakeAPIServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.APIService, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(apiservicesResource, tenant, name, pt, data, subresources...), &v1beta1.APIService{})
