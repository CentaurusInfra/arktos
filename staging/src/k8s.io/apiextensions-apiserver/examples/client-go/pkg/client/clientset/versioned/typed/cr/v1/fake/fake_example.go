...
// Watch returns a watch.AggregatedWatchInterface that watches the requested examples.
func (c *FakeExamples) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
