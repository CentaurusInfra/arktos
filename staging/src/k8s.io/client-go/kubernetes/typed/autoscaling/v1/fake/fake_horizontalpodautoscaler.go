...
func (c *FakeHorizontalPodAutoscalers) Get(name string, options v1.GetOptions) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, tenant), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) List(opts v1.ListOptions) (result *autoscalingv1.HorizontalPodAutoscalerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(horizontalpodautoscalersResource, horizontalpodautoscalersKind, c.ns, opts, c.te), &autoscalingv1.HorizontalPodAutoscalerList{})
...
// Watch returns a watch.AggregatedWatchInterface that watches the requested horizontalPodAutoscalers.
func (c *FakeHorizontalPodAutoscalers) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
	aggWatch := watch.NewAggregatedWatcher()
	watcher, err := c.Fake.
		InvokesWatch(testing.NewWatchActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, opts, c.te))
...
func (c *FakeHorizontalPodAutoscalers) Create(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, tenant), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Update(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, tenant), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) UpdateStatus(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (*autoscalingv1.HorizontalPodAutoscaler, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, "status", c.ns, horizontalPodAutoscaler, tenant), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, tenant), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, listOptions, c.te)
...
func (c *FakeHorizontalPodAutoscalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, tenant, c.ns, name, pt, data, subresources...), &autoscalingv1.HorizontalPodAutoscaler{})
