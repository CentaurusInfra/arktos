...
func (c *FakeHorizontalPodAutoscalers) Get(name string, options v1.GetOptions) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, c.te), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Create(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, c.te), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Update(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, c.te), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) UpdateStatus(horizontalPodAutoscaler *autoscalingv1.HorizontalPodAutoscaler) (*autoscalingv1.HorizontalPodAutoscaler, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, "status", c.ns, horizontalPodAutoscaler, c.te), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, c.te), &autoscalingv1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *autoscalingv1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, c.te, c.ns, name, pt, data, subresources...), &autoscalingv1.HorizontalPodAutoscaler{})
