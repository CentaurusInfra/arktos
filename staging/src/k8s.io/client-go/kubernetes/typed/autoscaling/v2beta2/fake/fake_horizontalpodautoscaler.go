...
func (c *FakeHorizontalPodAutoscalers) List(opts v1.ListOptions) (result *v2beta2.HorizontalPodAutoscalerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(horizontalpodautoscalersResource, horizontalpodautoscalersKind, c.ns, opts, c.te), &v2beta2.HorizontalPodAutoscalerList{})
