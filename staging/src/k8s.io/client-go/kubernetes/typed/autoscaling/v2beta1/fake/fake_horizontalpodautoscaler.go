...
func (c *FakeHorizontalPodAutoscalers) Get(name string, options v1.GetOptions) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, c.te), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Create(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, c.te), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Update(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, c.te), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) UpdateStatus(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (*v2beta1.HorizontalPodAutoscaler, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, "status", c.ns, horizontalPodAutoscaler, c.te), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, c.te), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, c.te, c.ns, name, pt, data, subresources...), &v2beta1.HorizontalPodAutoscaler{})
