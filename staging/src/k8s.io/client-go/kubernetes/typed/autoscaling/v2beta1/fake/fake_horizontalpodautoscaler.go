...
func (c *FakeHorizontalPodAutoscalers) Get(name string, options v1.GetOptions) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, tenant), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) List(opts v1.ListOptions) (result *v2beta1.HorizontalPodAutoscalerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(horizontalpodautoscalersResource, horizontalpodautoscalersKind, c.ns, opts, c.te), &v2beta1.HorizontalPodAutoscalerList{})
...
func (c *FakeHorizontalPodAutoscalers) Create(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, tenant), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Update(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, horizontalPodAutoscaler, tenant), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) UpdateStatus(horizontalPodAutoscaler *v2beta1.HorizontalPodAutoscaler) (*v2beta1.HorizontalPodAutoscaler, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, "status", c.ns, horizontalPodAutoscaler, tenant), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(horizontalpodautoscalersResource, c.ns, name, tenant), &v2beta1.HorizontalPodAutoscaler{})
...
func (c *FakeHorizontalPodAutoscalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2beta1.HorizontalPodAutoscaler, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(horizontalpodautoscalersResource, tenant, c.ns, name, pt, data, subresources...), &v2beta1.HorizontalPodAutoscaler{})
