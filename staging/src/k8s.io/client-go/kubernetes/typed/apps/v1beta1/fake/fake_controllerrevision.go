...
func (c *FakeControllerRevisions) Get(name string, options v1.GetOptions) (result *v1beta1.ControllerRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(controllerrevisionsResource, c.ns, name, c.te), &v1beta1.ControllerRevision{})
...
func (c *FakeControllerRevisions) Create(controllerRevision *v1beta1.ControllerRevision) (result *v1beta1.ControllerRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(controllerrevisionsResource, c.ns, controllerRevision, c.te), &v1beta1.ControllerRevision{})
...
func (c *FakeControllerRevisions) Update(controllerRevision *v1beta1.ControllerRevision) (result *v1beta1.ControllerRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(controllerrevisionsResource, c.ns, controllerRevision, c.te), &v1beta1.ControllerRevision{})
...
func (c *FakeControllerRevisions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(controllerrevisionsResource, c.ns, name, c.te), &v1beta1.ControllerRevision{})
...
func (c *FakeControllerRevisions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ControllerRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(controllerrevisionsResource, c.te, c.ns, name, pt, data, subresources...), &v1beta1.ControllerRevision{})
