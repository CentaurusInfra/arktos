...
func (c *FakeDeployments) Get(name string, options v1.GetOptions) (result *v1beta2.Deployment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(deploymentsResource, c.ns, name, tenant), &v1beta2.Deployment{})
...
func (c *FakeDeployments) Create(deployment *v1beta2.Deployment) (result *v1beta2.Deployment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(deploymentsResource, c.ns, deployment, tenant), &v1beta2.Deployment{})
...
func (c *FakeDeployments) Update(deployment *v1beta2.Deployment) (result *v1beta2.Deployment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(deploymentsResource, c.ns, deployment, tenant), &v1beta2.Deployment{})
...
func (c *FakeDeployments) UpdateStatus(deployment *v1beta2.Deployment) (*v1beta2.Deployment, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(deploymentsResource, "status", c.ns, deployment, tenant), &v1beta2.Deployment{})
...
func (c *FakeDeployments) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(deploymentsResource, c.ns, name, tenant), &v1beta2.Deployment{})
...
func (c *FakeDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Deployment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(deploymentsResource, tenant, c.ns, name, pt, data, subresources...), &v1beta2.Deployment{})
