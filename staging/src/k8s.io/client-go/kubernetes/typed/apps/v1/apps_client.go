...
func (c *AppsV1Client) ControllerRevisions(namespace string, optional_tenant ...string) ControllerRevisionInterface {
	return newControllerRevisions(c, namespace, optional_tenant...)
}

func (c *AppsV1Client) DaemonSets(namespace string, optional_tenant ...string) DaemonSetInterface {
	return newDaemonSets(c, namespace, optional_tenant...)
}

func (c *AppsV1Client) Deployments(namespace string, optional_tenant ...string) DeploymentInterface {
	return newDeployments(c, namespace, optional_tenant...)
}

func (c *AppsV1Client) ReplicaSets(namespace string, optional_tenant ...string) ReplicaSetInterface {
	return newReplicaSets(c, namespace, optional_tenant...)
}

func (c *AppsV1Client) StatefulSets(namespace string, optional_tenant ...string) StatefulSetInterface {
