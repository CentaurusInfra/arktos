...
func (c *FakeClusterRoles) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(clusterrolesResource, name, tenant), &v1alpha1.ClusterRole{})
...
func (c *FakeClusterRoles) Create(clusterRole *v1alpha1.ClusterRole) (result *v1alpha1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(clusterrolesResource, clusterRole, tenant), &v1alpha1.ClusterRole{})
...
func (c *FakeClusterRoles) Update(clusterRole *v1alpha1.ClusterRole) (result *v1alpha1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(clusterrolesResource, clusterRole, tenant), &v1alpha1.ClusterRole{})
...
func (c *FakeClusterRoles) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(clusterrolesResource, name, tenant), &v1alpha1.ClusterRole{})
...
func (c *FakeClusterRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(clusterrolesResource, tenant, name, pt, data, subresources...), &v1alpha1.ClusterRole{})
