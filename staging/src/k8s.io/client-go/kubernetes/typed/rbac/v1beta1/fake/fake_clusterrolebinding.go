...
func (c *FakeClusterRoleBindings) Get(name string, options v1.GetOptions) (result *v1beta1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(clusterrolebindingsResource, name, c.te), &v1beta1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Create(clusterRoleBinding *v1beta1.ClusterRoleBinding) (result *v1beta1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(clusterrolebindingsResource, clusterRoleBinding, c.te), &v1beta1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Update(clusterRoleBinding *v1beta1.ClusterRoleBinding) (result *v1beta1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(clusterrolebindingsResource, clusterRoleBinding, c.te), &v1beta1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(clusterrolebindingsResource, name, c.te), &v1beta1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(clusterrolebindingsResource, c.te, name, pt, data, subresources...), &v1beta1.ClusterRoleBinding{})
