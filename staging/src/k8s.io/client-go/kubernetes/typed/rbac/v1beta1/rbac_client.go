...
func (c *RbacV1beta1Client) Roles(namespace string, optional_tenant ...string) RoleInterface {
	return newRoles(c, namespace, optional_tenant...)
}

func (c *RbacV1beta1Client) RoleBindings(namespace string, optional_tenant ...string) RoleBindingInterface {
