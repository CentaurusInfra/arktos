...
func (c *FakeRoleBindings) Get(name string, options v1.GetOptions) (result *v1beta1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(rolebindingsResource, c.ns, name, tenant), &v1beta1.RoleBinding{})
...
func (c *FakeRoleBindings) List(opts v1.ListOptions) (result *v1beta1.RoleBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(rolebindingsResource, rolebindingsKind, c.ns, opts, c.te), &v1beta1.RoleBindingList{})
...
// Watch returns a watch.AggregatedWatchInterface that watches the requested roleBindings.
func (c *FakeRoleBindings) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
...
func (c *FakeRoleBindings) Create(roleBinding *v1beta1.RoleBinding) (result *v1beta1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(rolebindingsResource, c.ns, roleBinding, tenant), &v1beta1.RoleBinding{})
...
func (c *FakeRoleBindings) Update(roleBinding *v1beta1.RoleBinding) (result *v1beta1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(rolebindingsResource, c.ns, roleBinding, tenant), &v1beta1.RoleBinding{})
...
func (c *FakeRoleBindings) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(rolebindingsResource, c.ns, name, tenant), &v1beta1.RoleBinding{})
...
func (c *FakeRoleBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(rolebindingsResource, tenant, c.ns, name, pt, data, subresources...), &v1beta1.RoleBinding{})
