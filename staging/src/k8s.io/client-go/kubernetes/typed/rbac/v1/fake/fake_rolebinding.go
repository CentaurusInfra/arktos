...
func (c *FakeRoleBindings) Get(name string, options v1.GetOptions) (result *rbacv1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(rolebindingsResource, c.ns, name, tenant), &rbacv1.RoleBinding{})
...
func (c *FakeRoleBindings) Create(roleBinding *rbacv1.RoleBinding) (result *rbacv1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(rolebindingsResource, c.ns, roleBinding, tenant), &rbacv1.RoleBinding{})
...
func (c *FakeRoleBindings) Update(roleBinding *rbacv1.RoleBinding) (result *rbacv1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(rolebindingsResource, c.ns, roleBinding, tenant), &rbacv1.RoleBinding{})
...
func (c *FakeRoleBindings) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(rolebindingsResource, c.ns, name, tenant), &rbacv1.RoleBinding{})
...
func (c *FakeRoleBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *rbacv1.RoleBinding, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(rolebindingsResource, tenant, c.ns, name, pt, data, subresources...), &rbacv1.RoleBinding{})
