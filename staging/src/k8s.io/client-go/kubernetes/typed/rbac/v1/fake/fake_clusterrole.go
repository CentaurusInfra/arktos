...
func (c *FakeClusterRoles) Get(name string, options v1.GetOptions) (result *rbacv1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(clusterrolesResource, name, tenant), &rbacv1.ClusterRole{})
...
func (c *FakeClusterRoles) Create(clusterRole *rbacv1.ClusterRole) (result *rbacv1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(clusterrolesResource, clusterRole, tenant), &rbacv1.ClusterRole{})
...
func (c *FakeClusterRoles) Update(clusterRole *rbacv1.ClusterRole) (result *rbacv1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(clusterrolesResource, clusterRole, tenant), &rbacv1.ClusterRole{})
...
func (c *FakeClusterRoles) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(clusterrolesResource, name, tenant), &rbacv1.ClusterRole{})
...
func (c *FakeClusterRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *rbacv1.ClusterRole, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(clusterrolesResource, tenant, name, pt, data, subresources...), &rbacv1.ClusterRole{})
