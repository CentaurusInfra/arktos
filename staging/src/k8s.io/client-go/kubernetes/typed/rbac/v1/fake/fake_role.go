...
func (c *FakeRoles) Get(name string, options v1.GetOptions) (result *rbacv1.Role, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(rolesResource, c.ns, name, tenant), &rbacv1.Role{})
...
func (c *FakeRoles) Create(role *rbacv1.Role) (result *rbacv1.Role, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(rolesResource, c.ns, role, tenant), &rbacv1.Role{})
...
func (c *FakeRoles) Update(role *rbacv1.Role) (result *rbacv1.Role, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(rolesResource, c.ns, role, tenant), &rbacv1.Role{})
...
func (c *FakeRoles) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(rolesResource, c.ns, name, tenant), &rbacv1.Role{})
...
func (c *FakeRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *rbacv1.Role, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(rolesResource, tenant, c.ns, name, pt, data, subresources...), &rbacv1.Role{})
