...
// Watch returns a watch.AggregatedWatchInterface that watches the requested resourceQuotas.
func (c *FakeResourceQuotas) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
