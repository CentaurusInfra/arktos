...
// Watch returns a watch.AggregatedWatchInterface that watches the requested componentStatuses.
func (c *FakeComponentStatuses) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
