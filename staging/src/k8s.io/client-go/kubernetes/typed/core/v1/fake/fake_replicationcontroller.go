...
func (c *FakeReplicationControllers) List(opts v1.ListOptions) (result *corev1.ReplicationControllerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(replicationcontrollersResource, replicationcontrollersKind, c.ns, opts, c.te), &corev1.ReplicationControllerList{})
...
// Watch returns a watch.AggregatedWatchInterface that watches the requested replicationControllers.
func (c *FakeReplicationControllers) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
	aggWatch := watch.NewAggregatedWatcher()
	watcher, err := c.Fake.
		InvokesWatch(testing.NewWatchActionWithMultiTenancy(replicationcontrollersResource, c.ns, opts, c.te))
...
func (c *FakeReplicationControllers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithMultiTenancy(replicationcontrollersResource, c.ns, listOptions, c.te)
