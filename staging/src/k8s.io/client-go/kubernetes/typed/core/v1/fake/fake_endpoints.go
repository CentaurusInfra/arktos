...
// Watch returns a watch.AggregatedWatchInterface that watches the requested endpoints.
func (c *FakeEndpoints) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
