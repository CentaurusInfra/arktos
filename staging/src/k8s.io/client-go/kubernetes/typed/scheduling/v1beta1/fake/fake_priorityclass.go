...
func (c *FakePriorityClasses) Get(name string, options v1.GetOptions) (result *v1beta1.PriorityClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(priorityclassesResource, name, c.te), &v1beta1.PriorityClass{})
...
func (c *FakePriorityClasses) List(opts v1.ListOptions) (result *v1beta1.PriorityClassList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantListAction(priorityclassesResource, priorityclassesKind, opts, c.te), &v1beta1.PriorityClassList{})
...
func (c *FakePriorityClasses) Create(priorityClass *v1beta1.PriorityClass) (result *v1beta1.PriorityClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(priorityclassesResource, priorityClass, c.te), &v1beta1.PriorityClass{})
...
func (c *FakePriorityClasses) Update(priorityClass *v1beta1.PriorityClass) (result *v1beta1.PriorityClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(priorityclassesResource, priorityClass, c.te), &v1beta1.PriorityClass{})
...
func (c *FakePriorityClasses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(priorityclassesResource, name, c.te), &v1beta1.PriorityClass{})
...
func (c *FakePriorityClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PriorityClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(priorityclassesResource, c.te, name, pt, data, subresources...), &v1beta1.PriorityClass{})
