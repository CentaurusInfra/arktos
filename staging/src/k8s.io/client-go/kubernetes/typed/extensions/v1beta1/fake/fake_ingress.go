...
func (c *FakeIngresses) List(opts v1.ListOptions) (result *v1beta1.IngressList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithMultiTenancy(ingressesResource, ingressesKind, c.ns, opts, c.te), &v1beta1.IngressList{})
...
// Watch returns a watch.AggregatedWatchInterface that watches the requested ingresses.
func (c *FakeIngresses) Watch(opts v1.ListOptions) watch.AggregatedWatchInterface {
	aggWatch := watch.NewAggregatedWatcher()
	watcher, err := c.Fake.
		InvokesWatch(testing.NewWatchActionWithMultiTenancy(ingressesResource, c.ns, opts, c.te))
...
func (c *FakeIngresses) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithMultiTenancy(ingressesResource, c.ns, listOptions, c.te)
