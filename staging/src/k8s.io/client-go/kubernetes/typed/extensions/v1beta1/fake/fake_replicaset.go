...
func (c *FakeReplicaSets) Get(name string, options v1.GetOptions) (result *v1beta1.ReplicaSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(replicasetsResource, c.ns, name, c.te), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) Create(replicaSet *v1beta1.ReplicaSet) (result *v1beta1.ReplicaSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(replicasetsResource, c.ns, replicaSet, c.te), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) Update(replicaSet *v1beta1.ReplicaSet) (result *v1beta1.ReplicaSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(replicasetsResource, c.ns, replicaSet, c.te), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) UpdateStatus(replicaSet *v1beta1.ReplicaSet) (*v1beta1.ReplicaSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(replicasetsResource, "status", c.ns, replicaSet, c.te), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(replicasetsResource, c.ns, name, c.te), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ReplicaSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(replicasetsResource, c.te, c.ns, name, pt, data, subresources...), &v1beta1.ReplicaSet{})
...
func (c *FakeReplicaSets) GetScale(replicaSetName string, options v1.GetOptions) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetSubresourceActionWithMultiTenancy(replicasetsResource, c.ns, "scale", replicaSetName, c.te), &v1beta1.Scale{})
...
func (c *FakeReplicaSets) UpdateScale(replicaSetName string, scale *v1beta1.Scale) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(replicasetsResource, "scale", c.ns, scale, c.te), &v1beta1.Scale{})
