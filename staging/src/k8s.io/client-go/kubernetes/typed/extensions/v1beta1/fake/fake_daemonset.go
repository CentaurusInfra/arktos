...
func (c *FakeDaemonSets) Get(name string, options v1.GetOptions) (result *v1beta1.DaemonSet, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithMultiTenancy(daemonsetsResource, c.ns, name, tenant), &v1beta1.DaemonSet{})
...
func (c *FakeDaemonSets) Create(daemonSet *v1beta1.DaemonSet) (result *v1beta1.DaemonSet, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithMultiTenancy(daemonsetsResource, c.ns, daemonSet, tenant), &v1beta1.DaemonSet{})
...
func (c *FakeDaemonSets) Update(daemonSet *v1beta1.DaemonSet) (result *v1beta1.DaemonSet, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithMultiTenancy(daemonsetsResource, c.ns, daemonSet, tenant), &v1beta1.DaemonSet{})
...
func (c *FakeDaemonSets) UpdateStatus(daemonSet *v1beta1.DaemonSet) (*v1beta1.DaemonSet, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithMultiTenancy(daemonsetsResource, "status", c.ns, daemonSet, tenant), &v1beta1.DaemonSet{})
...
func (c *FakeDaemonSets) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithMultiTenancy(daemonsetsResource, c.ns, name, tenant), &v1beta1.DaemonSet{})
...
func (c *FakeDaemonSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.DaemonSet, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithMultiTenancy(daemonsetsResource, tenant, c.ns, name, pt, data, subresources...), &v1beta1.DaemonSet{})
