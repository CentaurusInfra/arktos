...
func (c *FakeVolumeAttachments) Get(name string, options v1.GetOptions) (result *storagev1.VolumeAttachment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(volumeattachmentsResource, name, tenant), &storagev1.VolumeAttachment{})
...
func (c *FakeVolumeAttachments) Create(volumeAttachment *storagev1.VolumeAttachment) (result *storagev1.VolumeAttachment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(volumeattachmentsResource, volumeAttachment, tenant), &storagev1.VolumeAttachment{})
...
func (c *FakeVolumeAttachments) Update(volumeAttachment *storagev1.VolumeAttachment) (result *storagev1.VolumeAttachment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(volumeattachmentsResource, volumeAttachment, tenant), &storagev1.VolumeAttachment{})
...
func (c *FakeVolumeAttachments) UpdateStatus(volumeAttachment *storagev1.VolumeAttachment) (*storagev1.VolumeAttachment, error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateSubresourceAction(volumeattachmentsResource, "status", volumeAttachment, tenant), &storagev1.VolumeAttachment{})
...
func (c *FakeVolumeAttachments) Delete(name string, options *v1.DeleteOptions) error {
	...
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(volumeattachmentsResource, name, tenant), &storagev1.VolumeAttachment{})
...
func (c *FakeVolumeAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *storagev1.VolumeAttachment, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(volumeattachmentsResource, tenant, name, pt, data, subresources...), &storagev1.VolumeAttachment{})
