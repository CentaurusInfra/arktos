...
func (s volumeAttachmentTenantLister) List(selector labels.Selector) (ret []*v1.VolumeAttachment, err error) {
...
func (s volumeAttachmentTenantLister) Get(name string) (*v1.VolumeAttachment, error) {
	key := s.tenant + "/" + name
	if s.tenant == "system" {
		key = name
	}
