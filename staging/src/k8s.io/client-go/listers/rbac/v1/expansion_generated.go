...
// ClusterRoleBindingTenantListerExpansion allows custom methods to be added to
// ClusterRoleBindingTenantLister.
type ClusterRoleBindingTenantListerExpansion interface{}
