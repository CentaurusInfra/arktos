...
import (
	v1 "k8s.io/arktos-ext/pkg/generated/clientset/versioned/typed/arktosextensions/v1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeArktosV1 struct {
	*testing.Fake
}
...
func (c *FakeArktosV1) RESTClient() rest.Interface {
...
func (c *FakeArktosV1) RESTClients() []rest.Interface {
	var ret *rest.RESTClient
