...
import (
	...
	v1 "github.com/kubeedge/kubeedge/cloud/pkg/client/listers/edgeclusters/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeclustersV1().EdgeClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeclustersV1().EdgeClusters().Watch(context.TODO(), options)
			},
		},
		&edgeclustersv1.EdgeCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *edgeClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&edgeclustersv1.EdgeCluster{}, f.defaultInformer)
}
