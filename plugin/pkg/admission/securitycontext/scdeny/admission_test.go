...
func TestAdmission(t *testing.T) {
	...
	for _, tc := range cases {
		...
		err := handler.Validate(admission.NewAttributesRecord(p, nil, api.Kind("Pod").WithVersion("version"), "test-te", "foo", "name", api.Resource("pods").WithVersion("version"), "", "ignored", nil, false, nil), nil)
...
func TestPodSecurityContextAdmission(t *testing.T) {
	...
	for _, test := range tests {
		...
		err := handler.Validate(admission.NewAttributesRecord(&pod, nil, api.Kind("Pod").WithVersion("version"), "test-te", "foo", "name", api.Resource("pods").WithVersion("version"), "", "ignored", nil, false, nil), nil)
