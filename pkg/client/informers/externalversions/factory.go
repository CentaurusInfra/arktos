...
import (
	...
	cloudgateway "k8s.io/kubernetes/pkg/client/informers/externalversions/cloudgateway"
...
type SharedInformerFactory interface {
	...
	Cloudgateway() cloudgateway.Interface
}

func (f *sharedInformerFactory) Cloudgateway() cloudgateway.Interface {
	return cloudgateway.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
