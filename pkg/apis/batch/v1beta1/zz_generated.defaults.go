...
func SetObjectDefaults_CronJob(in *v1beta1.CronJob) {
	...
	if in.Spec.JobTemplate.Spec.Template.Spec.VirtualMachine != nil {
		...
		v1.SetDefaults_ResourceList(&in.Spec.JobTemplate.Spec.Template.Spec.VirtualMachine.ResourcesAllocated)
	}
	for i := range in.Spec.JobTemplate.Spec.Template.Spec.WorkloadInfo {
		a := &in.Spec.JobTemplate.Spec.Template.Spec.WorkloadInfo[i]
		v1.SetDefaults_ResourceList(&a.Resources.Limits)
		v1.SetDefaults_ResourceList(&a.Resources.Requests)
		v1.SetDefaults_ResourceList(&a.ResourcesAllocated)
	}
...
func SetObjectDefaults_JobTemplate(in *v1beta1.JobTemplate) {
	...
	if in.Template.Spec.Template.Spec.VirtualMachine != nil {
		...
		v1.SetDefaults_ResourceList(&in.Template.Spec.Template.Spec.VirtualMachine.ResourcesAllocated)
	}
	for i := range in.Template.Spec.Template.Spec.WorkloadInfo {
		a := &in.Template.Spec.Template.Spec.WorkloadInfo[i]
		v1.SetDefaults_ResourceList(&a.Resources.Limits)
		v1.SetDefaults_ResourceList(&a.Resources.Requests)
		v1.SetDefaults_ResourceList(&a.ResourcesAllocated)
	}
