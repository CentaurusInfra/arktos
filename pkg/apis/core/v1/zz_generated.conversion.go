...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.NetworkList)(nil), (*core.NetworkList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkList_To_core_NetworkList(a.(*v1.NetworkList), b.(*core.NetworkList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NetworkList)(nil), (*v1.NetworkList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NetworkList_To_v1_NetworkList(a.(*core.NetworkList), b.(*v1.NetworkList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.NetworkSpec)(nil), (*core.NetworkSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkSpec_To_core_NetworkSpec(a.(*v1.NetworkSpec), b.(*core.NetworkSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NetworkSpec)(nil), (*v1.NetworkSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NetworkSpec_To_v1_NetworkSpec(a.(*core.NetworkSpec), b.(*v1.NetworkSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.NetworkStatus)(nil), (*core.NetworkStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkStatus_To_core_NetworkStatus(a.(*v1.NetworkStatus), b.(*core.NetworkStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NetworkStatus)(nil), (*v1.NetworkStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NetworkStatus_To_v1_NetworkStatus(a.(*core.NetworkStatus), b.(*v1.NetworkStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Network_To_core_Network(in *v1.Network, out *core.Network, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_NetworkSpec_To_core_NetworkSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_NetworkStatus_To_core_NetworkStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_Network_To_v1_Network(in *core.Network, out *v1.Network, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_core_NetworkSpec_To_v1_NetworkSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_core_NetworkStatus_To_v1_NetworkStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1_NetworkList_To_core_NetworkList(in *v1.NetworkList, out *core.NetworkList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]core.Network)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1_NetworkList_To_core_NetworkList is an autogenerated conversion function.
func Convert_v1_NetworkList_To_core_NetworkList(in *v1.NetworkList, out *core.NetworkList, s conversion.Scope) error {
	return autoConvert_v1_NetworkList_To_core_NetworkList(in, out, s)
}

func autoConvert_core_NetworkList_To_v1_NetworkList(in *core.NetworkList, out *v1.NetworkList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1.Network)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_core_NetworkList_To_v1_NetworkList is an autogenerated conversion function.
func Convert_core_NetworkList_To_v1_NetworkList(in *core.NetworkList, out *v1.NetworkList, s conversion.Scope) error {
	return autoConvert_core_NetworkList_To_v1_NetworkList(in, out, s)
}

func autoConvert_v1_NetworkSpec_To_core_NetworkSpec(in *v1.NetworkSpec, out *core.NetworkSpec, s conversion.Scope) error {
	out.Type = core.NetworkType(in.Type)
	out.VPCID = in.VPCID
	return nil
}

// Convert_v1_NetworkSpec_To_core_NetworkSpec is an autogenerated conversion function.
func Convert_v1_NetworkSpec_To_core_NetworkSpec(in *v1.NetworkSpec, out *core.NetworkSpec, s conversion.Scope) error {
	return autoConvert_v1_NetworkSpec_To_core_NetworkSpec(in, out, s)
}

func autoConvert_core_NetworkSpec_To_v1_NetworkSpec(in *core.NetworkSpec, out *v1.NetworkSpec, s conversion.Scope) error {
	out.Type = v1.NetworkType(in.Type)
	out.VPCID = in.VPCID
	return nil
}

// Convert_core_NetworkSpec_To_v1_NetworkSpec is an autogenerated conversion function.
func Convert_core_NetworkSpec_To_v1_NetworkSpec(in *core.NetworkSpec, out *v1.NetworkSpec, s conversion.Scope) error {
	return autoConvert_core_NetworkSpec_To_v1_NetworkSpec(in, out, s)
}

func autoConvert_v1_NetworkStatus_To_core_NetworkStatus(in *v1.NetworkStatus, out *core.NetworkStatus, s conversion.Scope) error {
	out.Phase = core.NetworkPhase(in.Phase)
	return nil
}

// Convert_v1_NetworkStatus_To_core_NetworkStatus is an autogenerated conversion function.
func Convert_v1_NetworkStatus_To_core_NetworkStatus(in *v1.NetworkStatus, out *core.NetworkStatus, s conversion.Scope) error {
	return autoConvert_v1_NetworkStatus_To_core_NetworkStatus(in, out, s)
}

func autoConvert_core_NetworkStatus_To_v1_NetworkStatus(in *core.NetworkStatus, out *v1.NetworkStatus, s conversion.Scope) error {
	out.Phase = v1.NetworkPhase(in.Phase)
	return nil
}

// Convert_core_NetworkStatus_To_v1_NetworkStatus is an autogenerated conversion function.
func Convert_core_NetworkStatus_To_v1_NetworkStatus(in *core.NetworkStatus, out *v1.NetworkStatus, s conversion.Scope) error {
	return autoConvert_core_NetworkStatus_To_v1_NetworkStatus(in, out, s)
}
