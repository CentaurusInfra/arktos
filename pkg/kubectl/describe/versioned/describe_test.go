...
func TestDescribePod(t *testing.T) {
	...
	d := PodDescriber{c}
	out, err := d.Describe(metav1.TenantSystem, "foo", "bar", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
...
func TestDescribePodTolerations(t *testing.T) {
	...
	c := &describeClient{T: t, Namespace: "foo", Interface: fake}
	d := PodDescriber{c}
	out, err := d.Describe(metav1.TenantSystem, "foo", "bar", describe.DescriberSettings{})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestDescribeNamespace(t *testing.T) {
	...
	out, err := d.Describe(metav1.TenantSystem, "", "myns", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestDescribePodPriority(t *testing.T) {
	...
	c := &describeClient{T: t, Namespace: "", Interface: fake}
	d := PodDescriber{c}
	out, err := d.Describe(metav1.TenantSystem, "", "bar", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestDescribeConfigMap(t *testing.T) {
	...
	out, err := d.Describe(metav1.TenantSystem, "foo", "mycm", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestDescribeLimitRange(t *testing.T) {
	...
	out, err := d.Describe(metav1.TenantSystem, "foo", "mylr", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestPodDescribeResultsSorted(t *testing.T) {
	...
	fake := fake.NewSimpleClientset(
		...
		&corev1.Pod{ObjectMeta: metav1.ObjectMeta{Tenant: metav1.TenantSystem, Namespace: "foo", Name: "bar"}},
	)
	c := &describeClient{T: t, Namespace: "foo", Interface: fake}
	d := PodDescriber{c}
...
func TestPersistentVolumeDescriber(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			plugin: "hostpath",
			pv: &corev1.PersistentVolume{
				ObjectMeta: metav1.ObjectMeta{Tenant: metav1.TenantSystem, Name: "bar"},
	...
	for _, test := range testCases {
		t.Run(test.name, func(t *testing.T) {
			...
			str, err := c.Describe(metav1.TenantSystem, "foo", "bar", describe.DescriberSettings{ShowEvents: true})
			if err != nil {
...
func TestPersistentVolumeClaimDescriber(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			name: "default",
			pvc: &corev1.PersistentVolumeClaim{
				ObjectMeta: metav1.ObjectMeta{Tenant: metav1.TenantSystem, Namespace: "foo", Name: "bar"},
...
func TestDescribeStorageClass(t *testing.T) {
	...
	out, err := s.Describe(metav1.TenantSystem, "", "foo", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
	if !strings.Contains(out, "foo") ||
...
func TestDescribePodDisruptionBudget(t *testing.T) {
	...
	out, err := s.Describe(metav1.TenantSystem, "ns1", "pdb1", describe.DescriberSettings{ShowEvents: true})
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
...
func TestDescribeHorizontalPodAutoscaler(t *testing.T) {
	...
	for _, test := range testsV2beta2 {
		t.Run(test.name, func(t *testing.T) {
			...
			str, err := desc.Describe(metav1.TenantSystem, "foo", "bar", describe.DescriberSettings{ShowEvents: true})
			if err != nil {
				t.Errorf("Unexpected error for test %s: %v", test.name, err)
			}
			if str == "" {
...
func TestDescribeEvents(t *testing.T) {
	...
	for name, d := range m {
		t.Run(name, func(t *testing.T) {
			...
			out, err = d.Describe(metav1.TenantSystem, "foo", "bar", describe.DescriberSettings{ShowEvents: false})
			if err != nil {
...
func TestDescribePodSecurityPolicy(t *testing.T) {
	...
	out, err := d.Describe(metav1.TenantSystem, "", "mypsp", describe.DescriberSettings{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
`
	...
	out, err := d.Describe(metav1.TenantSystem, "", "network-policy-1", describe.DescriberSettings{})
	if err != nil {
