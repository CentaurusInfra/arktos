...
func (g TestGroup) ResourcePathWithPrefix(prefix, resource, namespace, name string) string {
	return g.ResourcePathWithPrefixWithMultiTenancy(prefix, resource, metav1.TenantNone, namespace, name)
}
...
func (g TestGroup) ResourcePath(resource, namespace, name string) string {
	return g.ResourcePathWithPrefixWithMultiTenancy("", resource, metav1.TenantNone, namespace, name)
}
...
func (g TestGroup) SubResourcePath(resource, namespace, name, sub string) string {
	return g.SubResourcePathWithMultiTenancy(resource, metav1.TenantNone, namespace, name, sub)
}
