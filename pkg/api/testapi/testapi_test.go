...
func TestResourcePathWithPrefix(t *testing.T) {
	testCases := []struct {
		...
		{"prefix", "resource", "", "myresource", "/api/" + Default.GroupVersion().Version + "/prefix/tenants/all/resource/myresource"},
		{"prefix", "resource", "mynamespace", "", "/api/" + Default.GroupVersion().Version + "/prefix/tenants/system/namespaces/mynamespace/resource"},
		{"prefix", "resource", "", "", "/api/" + Default.GroupVersion().Version + "/prefix/tenants/all/resource"},
	...
	testGroupCases := []struct {
		...
		{"prefix", "resource", "", "myresource", "/apis/" + Admission.GroupVersion().Group + "/" + Admission.GroupVersion().Version + "/prefix/tenants/all/resource/myresource"},
		...
		{"prefix", "resource", "", "", "/apis/" + Admission.GroupVersion().Group + "/" + Admission.GroupVersion().Version + "/prefix/tenants/all/resource"},
...
func TestResourcePath(t *testing.T) {
	testCases := []struct {
		...
		{"resource", "mynamespace", "myresource", "/api/" + Default.GroupVersion().Version + "/tenants/system/namespaces/mynamespace/resource/myresource"},
		{"resource", "", "myresource", "/api/" + Default.GroupVersion().Version + "/tenants/all/resource/myresource"},
		{"resource", "mynamespace", "", "/api/" + Default.GroupVersion().Version + "/tenants/system/namespaces/mynamespace/resource"},
		{"resource", "", "", "/api/" + Default.GroupVersion().Version + "/tenants/all/resource"},
	}
	for _, item := range testCases {
...
func TestSubResourcePath(t *testing.T) {
	testCases := []struct {
		...
		{"resource", "", "myresource", "mysub", "/api/" + Default.GroupVersion().Version + "/tenants/all/resource/myresource/mysub"},
		{"resource", "mynamespace", "", "mysub", "/api/" + Default.GroupVersion().Version + "/tenants/system/namespaces/mynamespace/resource/mysub"},
		{"resource", "", "", "mysub", "/api/" + Default.GroupVersion().Version + "/tenants/all/resource/mysub"},
	}
	for _, item := range testCases {
