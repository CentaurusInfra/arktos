...
type VolumeHost interface {
	...
	GetSecretFunc() func(tenant, namespace, name string, ownerPodUID types.UID) (*v1.Secret, error)

	// Returns a function that returns a configmap.
	GetConfigMapFunc() func(tenant, namespace, name string, ownerPodUID types.UID) (*v1.ConfigMap, error)

	GetServiceAccountTokenFunc() func(tenant, namespace, name string, ownerPodUID types.UID, tr *authenticationv1.TokenRequest) (*authenticationv1.TokenRequest, error)
