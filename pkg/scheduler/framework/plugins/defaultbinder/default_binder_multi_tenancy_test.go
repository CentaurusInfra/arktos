...
func TestDefaultBinderWithMultiTenancy(t *testing.T) {
	testPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "ns", Tenant: testTenant},
	}
	...
	tests := []struct {
	...
	}{
		{
			name: "successful",
			wantBinding: &v1.Binding{
				ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "foo", Tenant: testTenant},
