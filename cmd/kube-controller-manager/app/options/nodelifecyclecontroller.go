...
func (o *NodeLifecycleControllerOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringSliceVar(&o.TenantPartitionKubeConfigs, "tenant-server-kubeconfigs", o.TenantPartitionKubeConfigs, "Comma separated string representing tenant api-server URLs.")
}
