...
Setup: 3 kube-apiservers with data partition, 1 workload-controller-manager, 1 kube-controller-manager, 1 kube-scheduler, same ETCD configuration as Kubernetes

Topology: TBD (currently 1st api server share host with ETCD, workload-controller-manager, kube-controller-manager, kube-scheduler; 2nd/3rd api server run on separate hosts)
...
Setup: 3 kube-apiservers with data partition, 1 workload-controller-manager, 1 kube-controller-manager, 1 kube-scheduler, 1 ETCD system cluster, 2 ETCD tenant clusters, 1 ETCD event cluster
...
Setup: 3 kube-apiservers with data partition, 4 workload-controller-managers, 1 kube-controller-manager, 1 kube-scheduler, 1 ETCD system cluster, 2 ETCD tenant clusters, 1 ETCD event cluster
